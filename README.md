...
instead `eval()` string parsing with injection defences, I might use: a full DSL, reflection (although I don't think it's sufficient to solve the problem), or an embeeded LUA machine\
\
*let the race begin*
